...
int scanhash_bastion(int thr_id, struct work *work, uint32_t max_nonce, unsigned long *hashes_done)
{
	...
	do {
		...
		x13_fugue512_cpu_hash_64(thr_id, branchNonces, d_hash_br1[thr_id]); order++;
		...
		// echo or luffa
		branchNonces = bastion_filter2(thr_id, throughput, d_hash[thr_id], d_hash_br1[thr_id], d_hash_br2[thr_id]);
		x11_echo512_cpu_hash_64(thr_id, branchNonces, d_hash_br1[thr_id]); order++;
		...
		// shabal or whirlpool
		branchNonces = bastion_filter2(thr_id, throughput, d_hash[thr_id], d_hash_br1[thr_id], d_hash_br2[thr_id]);
		x14_shabal512_cpu_hash_64(thr_id, branchNonces, d_hash_br1[thr_id]); order++;
		...
		// hamsi or luffa
		branchNonces = bastion_filter2(thr_id, throughput, d_hash[thr_id], d_hash_br1[thr_id], d_hash_br2[thr_id]);
		x13_hamsi512_cpu_hash_64(thr_id, branchNonces, d_hash_br1[thr_id]); order++;
		x11_luffa512_cpu_hash_64(thr_id, throughput - branchNonces, d_hash_br2[thr_id]); order++;
		bastion_merge2(thr_id, throughput, d_hash[thr_id], d_hash_br1[thr_id], d_hash_br2[thr_id]);
		TRACE("perm4  :");
